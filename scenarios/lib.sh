...
case "${DBOS_LAB_MODE:-fast}" in
  fast)
    ...
    export LAB_REVIEW_RECV_TIMEOUT="${LAB_REVIEW_RECV_TIMEOUT:-200ms}"
    export LAB_RECONCILE_RESOLUTION_TIMEOUT="${LAB_RECONCILE_RESOLUTION_TIMEOUT:-15}"
    ;;
  full)
    ...
    export LAB_REVIEW_RECV_TIMEOUT="${LAB_REVIEW_RECV_TIMEOUT:-2s}"
    export LAB_RECONCILE_RESOLUTION_TIMEOUT="${LAB_RECONCILE_RESOLUTION_TIMEOUT:-60}"
    ;;
  *)
